#ifndef CLRS_SRC_PART3_DATA_STRUCTURES_189_SKIP_LIST_H_
#define CLRS_SRC_PART3_DATA_STRUCTURES_189_SKIP_LIST_H_
...
class SkipList {
 ...
 private:
  ...
  int RandomLevel() {
    int tmp = 0;
    while (RandomDouble(0, 1) < p_ && tmp < max_level_) {
      tmp++;
    }
    return tmp;
  }
...
#endif  // CLRS_SRC_PART3_DATA_STRUCTURES_189_SKIP_LIST_H_
